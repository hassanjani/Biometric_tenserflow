...
import com.example.facerecognition.FinalActivity;
...
//                new ImageModel(getContentResolver()).saveImage(path);
    ...
    private void result(Double aDouble) {
        ...
        Log.d("StateLess",String.valueOf(aDouble));
...
//                            }
                            if(flag==3){
                                right.setBackgroundTintList(getResources().getColorStateList(R.color.green));
                                Intent intent = new Intent(CameraViewActivity.this, FinalActivity.class);
